...
def createTodaysGames(games, df, odds):
    ...
    for game in games:
        ...
        if odds is not None:
            ...
            todays_games_spreads.append(game_odds['away_spread_odds'])
            ...
            todays_games_spreads.append(input("Away Spread: " ))
    ...
    return data, todays_games_uo, frame_ml, home_team_odds, away_team_odds, todays_games_spreads
...
def main():
    ...
    data, todays_games_uo, frame_ml, home_team_odds, away_team_odds, todays_games_spreads = createTodaysGames(games, df, odds)
    if args.nn:
    ...
    if args.xgb:
        ...
        XGBoost_Runner.xgb_runner(data, todays_games_uo, frame_ml, games, home_team_odds, away_team_odds, args.kc, args.lg, todays_games_spreads)
        print("-------------------------------------------------------")
    if args.A:
        print("---------------XGBoost Model Predictions---------------")
        XGBoost_Runner.xgb_runner(data, todays_games_uo, frame_ml, games, home_team_odds, away_team_odds, args.kc, args.lg, todays_games_spreads)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-lg', action='store_true',
                        help='Run with last game stats. Currently only supported for xgb money line model.')
